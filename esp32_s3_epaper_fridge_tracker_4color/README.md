...
```json
{
  "host": "0.0.0.0",
  "port": 8788,
  "provisioningKey": "replace-with-a-local-secret"
}
```

在设备配网页面中填写 Mac 的局域网 URL，例如
`http://192.168.0.117:8788`，并填写相同的 provisioning key 及一个
新的绑定码。随后在手机 H5 页面登录并输入该绑定码。
